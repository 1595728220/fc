    ...
    <div class="container">
      ...
      <div class="register pr ml-auto mr-auto mt-5 mb-5 row" ref="father_area">
        ...
        <div class="col-sm-12 mb-3">
          ...
          <input type="text" placeholder="手机号" class="input_form" v-model="input_form.phone" @blur="func_phone_blur"
        ...
        <div class="col-sm-12 mb-3">
          ...
          <input type="password" placeholder="密码" class="input_form" v-model="input_form.upwd"
            :class="{input_form_error:!state_form.upwd}" @blur="func_upwd_blur">
          <!-- 密码表单结束 -->
        </div>
        ...
        <div class="col-sm-12 mb-3">
          ...
          <input type="password" placeholder="确认密码" class="input_form" v-model="input_form.cpwd"
            :class="{input_form_error:!state_form.cpwd}" @blur="func_cpwd_blur">
          <!-- 重复密码表单结束 -->
        </div>
        ...
        <div class="col-sm-12 mb-3">
          ...
          <div class="row m-0">
            <input type="text" placeholder="验证码" class="input_form col-sm-6 d-inline-block" v-model="input_form.iden"
